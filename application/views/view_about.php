                ...
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <label for="email" class="col-sm-10 col-form-label">Aplikasi ini dibuat oleh:</label>

                                <label for="email" class="col-sm-2 col-form-label">Nama</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="email" name="email"
                                        value="Silfiana Ika Riski" readonly>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="email" name="email" value="213170076"
                                        readonly>
                                </div>
