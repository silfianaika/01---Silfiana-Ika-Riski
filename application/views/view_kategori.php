    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="myLargeModalLabel">Kategori Surat >> Tambah</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row text-left">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input class="form-control" type="text" id="nama" name="nama" placeholder="Masukkan nama kategori">
                ...
                <div class="form-group row text-left">
                    ...
                    <div class="col-sm-9">
                        <textarea required class="form-control" rows="5" id="keterangan" name="keterangan" placeholder="Masukkan keterangan"></textarea>
